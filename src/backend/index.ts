...
const MONGODB_URI =
  process.env.MONGODB_URI || "mongodb://localhost:27017/DBPractice";
...
app.post("/api/form/send", async (req: Request, res: Response) => {
...
app.get("/api/form/get", async (req: Request, res: Response) => {
  try {
